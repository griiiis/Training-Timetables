...
public class AccountController : ControllerBase
{
    ...
    public AccountController(UserManager<App.Domain.Identity.AppUser> userManager, ILogger<AccountController> logger,
        SignInManager<App.Domain.Identity.AppUser> signInManager, IConfiguration configuration, AppDbContext context)
    {
        ...
        int expiresInSeconds)
    {
        ...
        var res = new JWTResponse()
        {
            ...
            Role = (await _userManager.GetRolesAsync(appUser)).ToList()[0],
    ...
    )
    {
        ...
        // load and compare refresh tokensMicrosoft.EntityFrameworkCore.Internal.IDbContextDependencies.StateManager = StateManager 
